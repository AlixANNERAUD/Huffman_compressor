...
\begin{tad}
    ...
    \begin{tadSemantiques}{is\_greater\_than}
        ...
        \tadSemantique{is\_leaf}{Renvoi si le noeud est une feuille.}
        \tadSemantique{get\_value}{Renvoi la valeur du noeud.}
        \tadSemantique{get\_right\_child}{Renvoi le fils droit du noeud.}
        \tadSemantique{get\_left\_child}{Renvoi le fils gauche du noeud.}
