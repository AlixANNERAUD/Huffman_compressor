...
\begin{algorithme}
    ...
    {add(table, byte, binaryCode): non(is\_present(codingTable, byte))}
    {i : [0..255]}
    {
        \affecter{i}{0}
    ...
    \espace
    \fonction{get\_code}{codingTable : \codingTable, byte : \byte}{\binaryCode}
    ...
    \\
    \fonction{is\_present}{codingTable : \codingTable, byte : \byte}{\booleen}{}
    {d, m, g : [0..255]}
    {
        \affecter{g}{0}
        \affecter{d}{codingTable.size}
