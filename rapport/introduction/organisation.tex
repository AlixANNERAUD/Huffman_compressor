...
\begin{center}\begin{tabular}{ | p{2.5cm} | p{2.5cm} || c | c | c | c | }
    ...
    \multicolumn{2}{ |c|| }{Conception détaillée} & \makecell{C \\ CB} & \makecell{D \\ A \\ T \\ O} & \makecell{C \\ S} & \makecell{D \\ F} \\

    \hline

    \multirow{2}{*}{Développement} & \makecell{Implémentation \\ Documentation} & \makecell{D \\ T \\ F} & \makecell{C \\ A} & \makecell{C \\ O} & \makecell{D \\ CB \\ S} \\
